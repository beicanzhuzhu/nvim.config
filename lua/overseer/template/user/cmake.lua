...
return {
	...
	generator = function(search)
		...
		return {
			...
			command_proxy("cmake-tools debug", "CMakeDebug"),
			command_proxy("cmake-tools debug current file", "CMakeDebugCurrentFile"),
			command_proxy("cmake-tools quick debug", "CMakeQuickDebug"),
